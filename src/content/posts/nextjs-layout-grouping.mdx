...
category: "dev"
description: "How to use Next.js route groups to apply different layouts on nested routes like /blog vs /blog/[slug] without client components or context providers."
---
